...
description: "Learn how to share your successful trading strategies with the Nimbus community and earn revenue from your expertise"
---

## Why Publish Your Strategies?

Publishing your successful trading strategies on the Nimbus marketplace creates multiple benefits:
...
<CheckList>
  - **Verified Nimbus account** (minimum 3 months active) - **Live trading
  history** (minimum 6 months of documented results) - **Positive community
  standing** (good reputation, no violations) - **Identity verification** (KYC
  compliance for revenue sharing) - **Contact information** (responsive support
  for subscribers) - **Tax compliance** (appropriate tax documentation for
  earnings)
