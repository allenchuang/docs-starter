...
description: "Solutions to common issues and problems in Hyperscript automated trading"
---

## Common Issues and Solutions

This troubleshooting guide addresses the most frequently encountered issues in Hyperscript. Use this guide to quickly diagnose and resolve problems with your automated trading strategies.
...
<AccordionGroup>
  <Accordion title="Cannot Connect Exchange Account">
    Problems linking exchange accounts to Hyperscript **Setup Checklist:**
    <CheckList>
...
<AccordionGroup>
  <Accordion title="Strategy Health Check">
    Use Hyperscript's built-in diagnostic tools **Health Check Items:**
    <CheckList>
...
<Accordion title="Community Support">
  ...
  <Accordion title="Direct Support">
    Contact Hyperscript support team **Support Channels:** - **Email Support**:
    support@hyperscript.xyz - **Live Chat**: Available during business hours -
...
<CardGroup cols={2}>
  ...
  <Card title="Support" href="mailto:support@hyperscript.xyz" icon="envelope">
