...
description: "Test and validate your trading strategies against historical data with Hyperscript's comprehensive backtesting framework"
---

## What is Backtesting?

Backtesting is the process of testing trading strategies against historical market data to evaluate their performance before deploying real capital. Hyperscript's backtesting engine provides comprehensive simulation capabilities with accurate orderbook modeling and realistic execution assumptions.
...
## Hyperscript's Backtesting Advantage
...
<Card title="Signal-Based Trading" icon="radar" href="/trading-strategies/signal-based-trading">
  Backtest strategies using Hyperscript's signal engine.
</Card>
</CardGroup>
